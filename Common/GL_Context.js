...
var texture_filenames_to_load = [ "stars.png", "text.png", "earth.tga", "ground4.png", "whispy_woods.png", "block2.png", "mushroom.png", "mushroom2.png", "the_end.png"];
...
function GL_Context( canvas_id )
	{																// Special WebGL-only Initialization
		...
		for( var i = 0; i < texture_filenames_to_load.length; i++ )
			initTexture( texture_filenames_to_load[i], false );		// Changed from true to false
	...
	GL_Context.prototype.register_display_object = function( object ) { this.displayObjects.push( object );  object.init_keys(); }
...
{	this.string_map = { };	this.m_text = new text_line( 20 ); 		this.start_index = 0;	this.tick = 0;
	...
	Debug_Screen.prototype.display = function(time)
	{
			...
			for( var i = 0, idx = this.start_index; i < 4 && i < strings.length; i++, idx = (idx + 1) % strings.length )
			{
				...
				this.m_text.draw( model_transform, mat4(), perspective(45, canvas.width/canvas.height, .1, 100), false );		// comment this out to not display any strings on the ui			
	...
	{
		//debug_screen_object.string_map["tick"] = "FPS: ";
